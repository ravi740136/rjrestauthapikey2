...
public class ApiKeyAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (apiKey != null && apiKey.equals(VALID_API_KEY)) {
           System.out.println("actual api key "+apiKey);
        ...
        System.out.println("exception has not occured");
            // Set the authentication context in the SecurityContextHolder
            SecurityContextHolder.getContext().setAuthentication(authentication);
        }
        
        System.out.println("api key authentication failed redirecting to login");
